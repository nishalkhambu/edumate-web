          ...
          <div className="rounded-3xl border border-slate-800/70 bg-white/[0.02] p-6">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium capitalize text-slate-100">{user?.role}</p>
              </div>
            </div>
          </div>
          <div className="rounded-3xl border border-slate-800/70 bg-white/[0.02] p-6">
            <h3 className="text-sm font-semibold text-slate-200">Preferences</h3>
            <p className="mt-2 text-sm text-slate-400">Theme, notifications and study preferences will live here.</p>
          </div>
        </div>
      </FadeIn>
    </PageShell>
