        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="relative hidden md:block">
            ...
            <input
              ...
              className="w-64 rounded-xl border border-slate-700 bg-white/5 py-2 pl-9 pr-3 text-sm text-slate-200 placeholder:text-slate-500 focus:border-indigo-500/60 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
            />
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden text-sm font-medium text-slate-200 sm:block">{name}</span>
            ...
            <AnimatePresence>
              {open && (
                ...
                >
                  <button className="w-full rounded-lg px-3 py-2 text-left text-sm text-slate-300 hover:bg-white/5">
                    Profile
                  </button>
                  <button className="w-full rounded-lg px-3 py-2 text-left text-sm text-slate-300 hover:bg-white/5">
                    Settings
