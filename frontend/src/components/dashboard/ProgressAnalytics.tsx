  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
      <div className="lg:col-span-3">
        <p className="section-label mb-3">Weekly Study Hours</p>
        <div className="h-56">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={weeklyAnalytics} margin={{ left: -18, right: 8, top: 8 }}>
              ...
              <Tooltip
                ...
                contentStyle={{ background: "#1e293b", border: "1px solid #2a3852", borderRadius: 12, color: "#f8fafc", fontSize: 12 }}
      ...
      <div className="lg:col-span-2">
        <p className="section-label mb-3">Subject Performance</p>
            ...
            <div key={s.subject}>
              <div className="mb-1 flex items-center justify-between text-sm">
                ...
                <span className="flex items-center gap-2">
                  ...
                  <span className={cn("text-[11px] font-semibold", s.trend >= 0 ? "text-emerald-400" : "text-rose-400")}>
