...
export function WelcomeSection() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-800/70 bg-gradient-to-br from-[#161f38] to-[#0f172a] p-7 sm:p-9">
      ...
      <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight tracking-tight text-slate-50 sm:text-4xl">
            {greeting}, {name} <span className="inline-block">👋</span>
          </h1>
          <p className="mt-3 max-w-xl text-base text-slate-400">{message}</p>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2.5 rounded-2xl border border-slate-700/60 bg-white/[0.03] px-4 py-2.5">
              ...
              <div className="leading-tight">
                <p className="text-[11px] uppercase tracking-wide text-slate-500">Today&apos;s focus</p>
                <p className="text-sm font-semibold text-slate-100">{todayFocus}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-center rounded-2xl border border-slate-700/60 bg-white/[0.03] px-5 py-4">
            ...
            <p className="mt-1 text-2xl font-bold text-slate-50">{Math.round(streakCount)}</p>
            <p className="text-[11px] uppercase tracking-wide text-slate-500">day streak</p>
          </div>
          ...
          <div className="relative flex h-28 w-28 items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center">
              <span className="text-xl font-bold text-slate-50">{Math.round(goalCount)}%</span>
              <span className="text-[10px] uppercase tracking-wide text-slate-500">weekly</span>
            </div>
          </div>
        </div>
      </div>
